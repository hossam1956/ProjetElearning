...
class ExerciceController extends AbstractController
{
    ...
    #[Route('/show/{id}', name: 'app_exercice.show')]
    ...
    #[Route('/add', name: 'app_exercice.add')]
    ...
    #[Route('/edit/{id}', name: 'app_exercice.edit')]
    ...
    #[Route('/delete/{id}', name: 'app_exercice.delete')]
    ...
    #[Route('/practice/{exercice_id}', name: 'app_exercice.practice')]
    ...
    #[Route('/{exercice_id}/resultat/{score}', name: 'app_exercice.result')]
