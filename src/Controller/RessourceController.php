...
class RessourceController extends AbstractController
{
     ...
     */
     ...
     public function showressource(RessourceRepository $ressourceRepository,ExerciceRepository $exerciceRepository,$idsection,SectionRepository $sectionRepository,Avancement $avancement,FormationRepository $formationRepository) 
    {   $user=$this->getUser();
        if($user){
